...
const Page = ({ params }: { params: { id: string } }) => {
  ...
  const { fetchTourGuideById, tourGuide, loading } =
    useContext(TourGuideContext);

  // Memoize the fetchTourGuideById function
  const memoizedFetchTourGuideById = useCallback(
  ...
  useEffect(() => {
    if (!tourGuide) {
      memoizedFetchTourGuideById();
    }
  }, [memoizedFetchTourGuideById, tourGuide]);
                ...
                <div className="box-border w-full md:pr-[1.5rem]">
                  <div className="box-border w-full text-teal-800 border-b-[2px] py-[2rem] font-[500]">
                    ...
                    <p className="box-border w-full text-[1rem] text-teal-900 leading-[2rem]">
                      ...
                      landscapes of Côte d&apos;Ivoire with our immersive day
                      tour. Led by an expert local guide, this tour will take
                      you on a journey through bustling markets, historical
                      landmarks, and picturesque villages, offering a unique
                      glimpse into the life and traditions of the Ivorian
                      people.
                    </p>
                ...
                <div className="box-border w-full">
                  <div className="box-border w-full border-b-[2px] py-[2rem]">
                    ...
                    <p className="box-border w-full text-[1rem] text-teal-900 tracking-wider leading-[2rem] font-[500]">
                      {/* I am an adventurous life enthusiast, passionate traveler,
                    and dedicated volunteer. <br /> I&apos;ve hitchhiked around
                    Côte d&apos;Ivoire, explored hidden trails, and immersed
                    myself in local culture. Adore Abidjan! I am your travel
                    companion here for any adventure. <br /> However, I
                    don&apos;t expect to find any romantic relationships through
                    this platform. If that’s your goal, I&apos;m not the right
                    person for you. 🤍 */}
                      {tourGuide.aboutMe}
                    </p>
                  </div>
                  ...
                  <div className="w-full flex justify-center items-center p-[2rem] md:px-[0.5rem]">
                    <div className="w-full flex justify-center items-center border-b-[2px] pb-[2rem]">
                      ...
                      <div className="flex h-full justify-end items-center gap-x-[0.35rem]">
                        <div>
                          <p className="text-[1.3rem]">{tourGuide.rating}</p>
                        </div>
